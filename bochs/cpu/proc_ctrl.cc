...
extern "C" {
void RealCPUID(Bit64u, void*, Bit64u);
}
...
//
    ...
    //BX_PANIC(("handleAlignmentCheck called"));
}
#endif
...
#if BX_CPU_LEVEL >= 4
  MSG((thread_index, OUTPUT_BOTH, "from handleCpuContextChange"));
...
{
    MSG((thread_index, OUTPUT_BOTH, "RDTSCP called"));
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::SYSEXIT(bxInstruction_c *i)
{
  ...
  updateFetchModeMask(/* CS reloaded */);
#endif
  MSG((thread_index, OUTPUT_BOTH, "from SYSENTER"));
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::SYSCALL(bxInstruction_c *i)
{
    ...
    BX_PANIC(("SYSCALL called: RAX = %llx\n"));
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::SYSRET(bxInstruction_c *i)
{
  ...
  if (BX_CPU_THIS_PTR cpu_mode == BX_MODE_LONG_64)
  {
    ...
    MSG((thread_index, OUTPUT_BOTH, "from SYSRET"));
    handleAlignmentCheck(/* CPL change */);
...
#endif
  {
    ...
    MSG((thread_index, OUTPUT_BOTH, "from SYSRET cpl change"));
    handleAlignmentCheck(/* CPL change */);
