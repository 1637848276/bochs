...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::CLI(bxInstruction_c *i)
{
  ...
  MSG((thread_index, OUTPUT_BOTH, "#CLI called"));
...
{
  Bit32u IOPL = BX_CPU_THIS_PTR get_IOPL();
  MSG((thread_index, OUTPUT_BOTH, "#STI"));

  //Exception(this, EXCEPTION_PRIV_INSTRUCTION, 0, 0, 0);
...
{
    //MSG((thread_index, OUTPUT_BOTH, "POPF"));
