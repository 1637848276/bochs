...
#define FetchBYTE(a)  readByte((bx_address)a)
#define FetchWORD(a)  readWord((bx_address)a)
#define FetchDWORD(a) readDword((bx_address)a)
#define FetchQWORD(a) readQword((bx_address)a)
