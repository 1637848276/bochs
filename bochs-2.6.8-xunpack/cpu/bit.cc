/////////////////////////////////////////////////////////////////////////
// $Id: bit.cc 12516 2014-10-20 21:10:52Z sshwarts $
/////////////////////////////////////////////////////////////////////////
//
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::BSWAP_RX(bxInstruction_c *i)
{
  ...
  if(!cnt) {
     cnt = 1;
     BX_ERROR(("BSWAP with 16-bit opsize: undefined behavior ! (this message will not be displayed again) : RIP = %llx", prev_rip));
  }
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::BSWAP_ERX(bxInstruction_c *i)
{
 ...
 // if( prev_rip == 0x1401acc85) MSG((0, 3, "bswap rcx = %llx", RCX));
