...
#define agen_write32(s, offset, x) offset
#define agen_write_aligned32(s, offset, x) offset
#define agen_read32(s, offset, x) offset
#define agen_read_aligned32(s, offset, x) offset

#define agen_write(s, offset, x) offset
#define agen_write_aligned(s, offset, x) offset
#define agen_read(s, offset, x) offset
#define agen_read_aligned(s, offset, x) offset
...
#undef agen_writ32
#undef agen_write_aligned32
#undef agen_read32
#undef agen_read_aligned32

#undef agen_writ
#undef agen_write_aligned
#undef agen_read
#undef agen_read_aligned
