...
#define BX_INFO(x)  bx_info x
#define BX_DEBUG(x) bx_debug x
#define BX_ERROR(x) bx_error x
#define BX_PANIC(x) bx_panic x
...
#define BX_INFO MSG0
#define BX_DEBUG(x)
#define BX_ERROR MSG0
#define BX_PANIC MSG0
